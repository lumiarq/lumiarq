...
<head>
  ...
  <title>${__t('docs.unavailable_title')} — LumiARQ</title>
...
>
  ...
  <main class="docs-unavailable mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
    <section class="docs-unavailable-card mx-auto w-full max-w-2xl" role="status">
      <h1 class="unavailable-title">${__t('docs.unavailable_title')}</h1>
      <p class="unavailable-message">${__t('docs.unavailable_message')}</p>
      <a href="`
  __o += __e(site.nav.home)
  __o += `" class="unavailable-link">${__t('docs.back_home')}</a>
    </section>
  </main>
  <script>
;(function () {
